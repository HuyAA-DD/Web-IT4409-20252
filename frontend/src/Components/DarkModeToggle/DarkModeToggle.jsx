...
const DarkModeToggle = ({isDarkMode, toggleDarkMode, className=''}) => {
    return (
      ...
      > 
        <div className={`h-[90%] aspect-square rounded-full opacity-80 transition-transform duration-700  flex items-center justify-center`}>
          <div className={`animate-bounce duration-700 ${!isDarkMode ? "bg-amber-300 translate-x-0" : "bg-gray-500 -translate-x-[160%]"} w-full h-full rounded-full flex items-center justify-center`}>
            {!isDarkMode ? (
